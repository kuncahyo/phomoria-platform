...
public final class AppSettings {
    private String apiServer = "http://127.0.0.1:8000";
    ...
    public void setApiServer(String value) { apiServer = value == null ? "" : value.trim(); }
    ...
    public void setCustomPaperWidthInches(double value) {
        customPaperWidthInches =
                clampPaperDimension(value);
    }
    ...
    public void setPhotoEffectSettings(PhotoEffectSettings value) {
        photoEffectSettings = value == null ? new PhotoEffectSettings() : value;
    }
}
