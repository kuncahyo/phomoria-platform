...
public final class FramePreviewPanel extends JPanel {
    ...
    public void setFrameDefinition(
    ...
    public void setPhotos(
        ...
        if (selectedIndex >= this.photos.size()) {
            selectedIndex = -1;
        }
    ...
    private Rectangle frameBounds() {
        ...
        double aspect =
                frameDefinition.getWidth()
                        / (double)
                        frameDefinition.getHeight();
    ...
    private int slotAt(int mx, int my) {
        ...
        for (FramePlacement placement :
                frameDefinition.getPlacements()) {
            ...
            if (r.contains(mx, my)) {
                return placement.sourceSlotIndex();
            }
        }
