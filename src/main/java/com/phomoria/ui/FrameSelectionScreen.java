...
public final class FrameSelectionScreen extends JPanel {
    ...
    private void refreshPresets() {
        ...
        FrameCategory category =
                (FrameCategory) categoryBox.getSelectedItem();

        List<FramePreset> presets =
                FrameCatalog.byCategory(category);

        DebugLog.info(
                "Frame selection category="
                        + category
                        + ", presets="
                        + presets.size()
        );
    ...
    private JPanel createPresetCard(
        ...
        preview.setHorizontalAlignment(
                SwingConstants.CENTER
        );
        ...
        JButton select =
                new JButton("GUNAKAN FRAME INI");

        select.addActionListener(
                e -> selectPreset(preset)
        );
    ...
    private ImageIcon createSimulationPreview(
            FramePreset preset
    ) {
